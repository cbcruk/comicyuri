/**
 * N-401~405, N-407 · 주소와 이동. 뒤로 가기와 새로고침, 그리고 링크가 페이지를 다시
...
/**
 * N-407 · 배포된 곳에서도 `/book/<id>`로 곧장 들어올 수 있어야 한다.
 *
 ...
 * 빌드를 만들었다. GitHub Pages는 따로 `github-pages.spec.ts`가 본다.
 */
test('N-407 · 빌드 결과가 SPA 폴백 설정을 지고 나간다', async () => {
