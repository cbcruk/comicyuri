...
import { ZOOM_MIN } from '../../page/reader/gesture.ts'
import type { Point } from '../../page/reader/gesture.ts'
import { sideOf } from '../../page/reader/half.ts'
import { swapsSides } from '../../page/reader/rotation.ts'
import { indexOfPage, pagesAt, splitRatio, spreadsFor } from '../../page/reader/spread.ts'
