    ...
    <>
      ...
      >
        ...
        */}
        ...
        >
          <VStack gap={4}>
            <DialogHeader title={t('footer.goToPage')} onOpenChange={changeOpen} />
            <NumberInput
              key={openings}
              ref={boxRef}
              label={t('footer.pageRange', { pageCount })}
              hasAutoFocus={true}
              value={null}
            ...
            <HStack justify="end" gap={2}>
              ...
              />
              <Button label={t('footer.go')} variant="primary" onClick={submit} />
            </HStack>
          </VStack>
        </div>
      </Dialog>
