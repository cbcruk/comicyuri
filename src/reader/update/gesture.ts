  ...
  Gesture.$match(model.gesture, {
    ...
    Pinching: (pinching) => {
      ...
      return evo(zoomed, {
        gesture: () =>
          Gesture.Pinching({
            firstId: pinching.firstId,
            secondId: pinching.secondId,
            first,
            second,
            startSpan: pinching.startSpan,
            startZoom: pinching.startZoom,
          }),
      })
    },
  })
