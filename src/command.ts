...
import { loadProgress, saveBookSettings, saveProgress, saveSettings } from './io/storage.ts'
import { makeCover } from './io/thumbnail.ts'
import { BookSettings, PageMark, Rotation, Settings, Theme } from './types.ts'
...
export const SaveProgress = Command.define('SaveProgress', {
  ...
  execute: ({ bookId, page, bookmarks, marks, rotation }) =>
    loadProgress(bookId)
      .pipe(
